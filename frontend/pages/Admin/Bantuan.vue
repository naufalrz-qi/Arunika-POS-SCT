...
const istilah = [
  ...
  { t: "Sumber Modal", d: "Server yang jadi acuan bagi server lain: untuk harga pokok, dan untuk saran harga di server non-retail. Diatur per koneksi di menu Koneksi Server. Kalau rantainya belum sampai ke server gudang, saran harga tidak bisa dihitung.", ke: "/admin-panel/connections", nama: "Koneksi Server" },
