...
const istilah = [
  ...
  { t: "Sumber Modal", d: "Server yang jadi acuan bagi server lain: untuk harga pokok, dan untuk saran harga di server non-retail. Diatur per koneksi di menu Koneksi Server. TIDAK wajib diisi — kalau kosong (atau server acuannya sedang mati), yang terjadi hanya tidak ada saran harga; sisanya berjalan normal.", ke: "/admin-panel/connections", nama: "Koneksi Server" },
