...
const columns = [
  ...
  { key: "jth_tempo", label: "Jth. Tempo", format: "date", opsional: true },
  { key: "status", label: "Status" },
  { key: "keterangan", label: "Ket.", opsional: true },
  { key: "kd_barang", label: "Kode Barang" },
  { key: "barang", label: "Barang" },
  { key: "kategori", label: "Kategori", opsional: true },
  { key: "sales", label: "Sales", opsional: true },
  { key: "qty", label: "Qty", align: "right", format: "number" },
  { key: "satuan", label: "Satuan" },
  { key: "harga", label: "Harga", align: "right", format: "rupiah" },
  { key: "dd1", label: "DD1", align: "right", format: "rupiah", opsional: true },
  { key: "dd2", label: "DD2", align: "right", format: "rupiah", opsional: true },
  { key: "dd3", label: "DD3", align: "right", format: "rupiah", opsional: true },
  { key: "dd4", label: "DD4", align: "right", format: "rupiah", opsional: true },
  { key: "dt1", label: "DT1", align: "right", format: "rupiah", opsional: true },
  { key: "dt2", label: "DT2", align: "right", format: "rupiah", opsional: true },
  { key: "dt3", label: "DT3", align: "right", format: "rupiah", opsional: true },
  { key: "dt4", label: "DT4", align: "right", format: "rupiah", opsional: true },
  { key: "harga_bersih", label: "Harga Bersih", align: "right", format: "rupiah", opsional: true },
