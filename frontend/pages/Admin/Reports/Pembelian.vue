...
const columns = [
  ...
  { key: "no_order", label: "No Order", opsional: true },
  { key: "tanggal", label: "Tanggal", format: "datetime" },
  { key: "tanggal_server", label: "Tanggal Server", format: "datetime" },
  { key: "supplier", label: "Supplier" },
  { key: "note", label: "Note", opsional: true },
  { key: "barang", label: "Barang" },
  { key: "qty", label: "Qty", align: "right", format: "number" },
  { key: "satuan", label: "Satuan" },
  { key: "harga", label: "Harga Beli", align: "right", format: "rupiah" },
  { key: "diskon_item1", label: "Diskon Item 1", align: "right", format: "rupiah", opsional: true },
  { key: "diskon_item2", label: "Diskon Item 2", align: "right", format: "rupiah", opsional: true },
  { key: "diskon_item3", label: "Diskon Item 3", align: "right", format: "rupiah", opsional: true },
  { key: "diskon_item4", label: "Diskon Item 4", align: "right", format: "rupiah", opsional: true },
  { key: "diskon_total1", label: "Diskon Total 1", align: "right", format: "rupiah", opsional: true },
  { key: "diskon_total2", label: "Diskon Total 2", align: "right", format: "rupiah", opsional: true },
  { key: "diskon_total3", label: "Diskon Total 3", align: "right", format: "rupiah", opsional: true },
  { key: "diskon_total4", label: "Diskon Total 4", align: "right", format: "rupiah", opsional: true },
  { key: "pajak", label: "Pajak", align: "right", format: "number", opsional: true },
  { key: "ppnbm", label: "PPnBM", align: "right", format: "number", opsional: true },
