...
const columns = [
  ...
  { key: "keterangan_divisi", label: "Keterangan Divisi", opsional: true },
  { key: "kepala_nota", label: "Kepala Nota", opsional: true },
  { key: "customer", label: "Customer" },
  { key: "barang", label: "Barang" },
  { key: "satuan", label: "Satuan" },
  { key: "jenis_bayar", label: "Jenis Bayar" },
  { key: "no_rekening", label: "No. Rekening", opsional: true },
  { key: "bank", label: "Bank", opsional: true },
