...
urlpatterns = [
    ...
    path("analitik/deadstock", views.deadstock, name="deadstock"),
    path("analitik/deadstock/export", views.deadstock_export, name="deadstock_export"),
    path("analitik/deadstock/detail", views.deadstock_detail, name="deadstock_detail"),
