...
urlpatterns = [
    ...
    path("master/audit-harga-beli", views.audit_harga_beli_index, name="audit_harga_beli"),
    path("master/audit-harga-beli/terapkan", views.audit_harga_beli_terapkan, name="audit_harga_beli_terapkan"),
