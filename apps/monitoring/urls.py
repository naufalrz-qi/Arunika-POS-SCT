...
urlpatterns = [
    ...
    path("master/update-barang/harga-bulk", views.update_barang_harga_bulk, name="update_barang_harga_bulk"),
    ...
    path("master/perubahan-harga-harian", views.perubahan_harga_harian_index, name="perubahan_harga_harian"),
